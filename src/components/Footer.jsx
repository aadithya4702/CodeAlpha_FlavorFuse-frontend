    ...
    <div className="bg-stone-100 p-2 text-black py-12 mt-3">
      <div className="container mx-auto flex flex-wrap justify-between">
        <div className="w-full sm:w-1/2 lg:w-1/4 mb-8 sm:mb-0">
          ...
          <p>
            "FlavorFuse: Where Taste Meets Innovation! Savor Every Moment with
            FlavorFuse. Ignite Your Culinary Creativity with FlavorFuse!"
          </p>
        </div>
        <div className="w-full mt-3 sm:w-1/2 lg:w-1/4 mb-8 sm:mb-0">
          <h3 className="text-xl font-semibold mb-4">FlavorFuse</h3>
          <ul>
            <li>About us</li>
            <li>Contact us</li>
          </ul>
      ...
      <div className="container mx-auto mt-8 flex items-center  justify-between border-t-2  border-gray-600">
        <div className="flex items-center ">
          ...
          <p className="text-sm">FlavorFuse - All rights reserved</p>
        </div>
